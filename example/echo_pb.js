...
goog.exportSymbol('proto.echo.EchoStreamResponse', null, global);
/**
...
proto.echo.EchoResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.echo.EchoResponse.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.echo.EchoStreamResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.echo.EchoStreamResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.echo.EchoStreamResponse.displayName = 'proto.echo.EchoStreamResponse';
}
...
proto.echo.EchoRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    extraTimes: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
 ...
 * @return {string}
 */
proto.echo.EchoRequest.prototype.getValue = function() {
 ...
 */
proto.echo.EchoRequest.prototype.setValue = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional uint32 extra_times = 2;
 * @return {number}
 */
proto.echo.EchoRequest.prototype.getExtraTimes = function() {
 ...
 * @return {!proto.echo.EchoRequest} returns this
 */
proto.echo.EchoRequest.prototype.setExtraTimes = function(value) {
 ...
 * @const
 */
proto.echo.EchoResponse.repeatedFields_ = [1];
 ...
 * @return {!Array<string>}
 */
proto.echo.EchoResponse.prototype.getValuesList = function() {
 ...
 */
proto.echo.EchoResponse.prototype.setValuesList = function(value) {
 ...
 * @return {!proto.echo.EchoResponse} returns this
 */
proto.echo.EchoResponse.prototype.addValues = function(value, opt_index) {
 ...
 * @return {!proto.echo.EchoResponse} returns this
 */
proto.echo.EchoResponse.prototype.clearValuesList = function() {
 ...
 * @return {!Object}
 */
proto.echo.EchoStreamResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.echo.EchoStreamResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.echo.EchoStreamResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.echo.EchoStreamResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    value: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.echo.EchoStreamResponse}
 */
proto.echo.EchoStreamResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.echo.EchoStreamResponse;
  return proto.echo.EchoStreamResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.echo.EchoStreamResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.echo.EchoStreamResponse}
 */
proto.echo.EchoStreamResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.echo.EchoStreamResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.echo.EchoStreamResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.echo.EchoStreamResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.echo.EchoStreamResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getValue();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.echo.EchoStreamResponse.prototype.getValue = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.echo.EchoStreamResponse} returns this
 */
proto.echo.EchoStreamResponse.prototype.setValue = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
